...
begin
   ...
   if Traffic_Light(dir) = 4 then 		--Red
      Traffic_Light(dir) := 4;						--No delay here; maybe should add one.
      delay 1.0;
      Traffic_Light(dir) := 6;                    --Safety Req: Amber phase must last at least 3 seconds
   ...
   elsif Traffic_Light(dir) = 1 then		--Green needs to last a min of 4 second but that may be taken care of above; need to test.
